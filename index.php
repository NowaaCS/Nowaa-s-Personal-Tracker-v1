...
">
                ...
                <button class="material-symbols-outlined tooltip" id="rotation-toggle-button" style="transition: var(--transition-time)" onclick="toggleTheme()">toggle_on<span class="tooltiptext">Change theme</span></button>
